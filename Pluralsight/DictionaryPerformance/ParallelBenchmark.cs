...
namespace Pluralsight.ConcurrentCollections.DictionaryPerformance
{
    ...
    {
        public static void PopulateDictParallel(ConcurrentDictionary<int, int> dict, int dictSize)
        {
        ...
        public static int GetTotalValueParallel(ConcurrentDictionary<int, int> dict)
        {
